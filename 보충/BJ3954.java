...
//	static Stack<LoopInst> stack;
	...
	public static void main(String[] args) throws IOException {
		...
		for (int tc = 1; tc <= T; tc++) {
			...
			/*
			 * // makeLoopPair loopPairs = new ArrayList<>(); for (instPos = 0; instPos < C;
			 * instPos++) { char ch = inst[instPos]; if (ch == '[') { stack.push(new
			 * LoopInst(instPos, 0)); }
			 * 
			 * if (ch == ']') { LoopInst loop1 = stack.pop(); LoopInst loop2 = new
			 * LoopInst(instPos, 1); loopPairs.add(new LoopPair(loop1, loop2)); } }
			 */
...
//				System.out.println("Loops " + loopInstPos1 + " " + loopInstPos2);
				  ...
				  System.out.print("Loops "); findLoops();
	...
	private static boolean instLoop2() {
		if (mem[memPos] != 0) {
			...
			/*
			 * for (int i = 0; i < loopPairs.size(); i++) { if (loopPairs.get(i).loop2.pos
			 * == instPos) { instPos = loopPairs.get(i).loop1.pos; loopInstPos1 =
			 * loopPairs.get(i).loop1.pos; loopInstPos2 = loopPairs.get(i).loop2.pos; break;
			 * } }
			 */
	...
	private static boolean instLoop1() {
		if (mem[memPos] == 0) {
			...
			/*
			 * for (int i = 0; i < loopPairs.size(); i++) { if (loopPairs.get(i).loop1.pos
			 * == instPos) { instPos = loopPairs.get(i).loop2.pos;
			 * 
			 * loopInstPos1 = loopPairs.get(i).loop1.pos; loopInstPos2 =
			 * loopPairs.get(i).loop2.pos; break; } }
			 */
...
*/
		 ...
		 * for (int i = 0; i < loopPairs.size(); i++) { if (loopPairs.get(i).loop1.pos
		 * <= instPos && instPos <= loopPairs.get(i).loop2.pos) {
		 * System.out.println(loopPairs.get(i).loop1.pos + " " +
		 * loopPairs.get(i).loop2.pos); break; } }
		 */
